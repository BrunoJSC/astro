...
/**
 * `default` and `reply` are user-authored; the rest are generated by the
 * server. Keeping them in one table -- rather than a separate system-events
 * table -- is what lets a channel render as a single ordered stream.
 */
