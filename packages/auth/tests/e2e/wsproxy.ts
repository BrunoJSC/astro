 ...
 *
 * Duplicated from `packages/db/tests/e2e/wsproxy.ts` rather than shared. Forty
 * lines of test scaffolding in two places beats a package that exists only to
 * hold them, and importing across package boundaries in tests couples their
 * build order for no gain.
 *
