...
/**
 * The entry screen, and a live check that all four seams are wired: the design
 * system renders, Eden reaches the API, Better Auth reads a session, and the
 * Rust side answers over IPC.
 *
